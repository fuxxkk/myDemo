...
<div>
    ...
    <form action="/login" method="post">
        <div  class="d1">
            <div class="d2">
                <div class="d3">
                    <input type="text" name="username" id="usernameId" style="width:205px;height:25px" value=${username} ></br>
                    <div/>
                    <div class="d4">
                        <input type="text" name="password" id="passwordId" style="width:205px;height:25px" value=${password}  ></br>

                    </div>
                    <div class="d4">
                        <span class="d5" style="width:205px;height:25px">${error}</span>
                    </div>
